...
<div id="header">
	...
	<div id="searchbar">
		...
		<form method="get" action="<?= $www_prefix ?>/search/search.cgi"><input type="hidden" name="t" value="All" /><input type="hidden" name="t" value="Downloads" /><input type="hidden" name="t" value="Live" /><input type="hidden" name="t" value="Wiki" /><input type="hidden" name="wf" value="574a74" /><input type="text" name="q" value="" /><input type="image" class="button" src="/eclipse.org-common/themes/Phoenix/images/searchbar_submit.gif" alt="Submit" onclick="this.submit();" /></form>
	</div>
	<ul id="headernav">
