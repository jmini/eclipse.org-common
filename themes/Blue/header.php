...
<head>
	...
	<link rel="stylesheet" type="text/css" href="/eclipse.org-common/themes/Blue/css/visual.css" media="screen" />
...
<div id="header"> <a href="http://www.eclipse.org/"><img src="/eclipse.org-common/themes/Blue/images/header_logo.gif" alt="Eclipse Logo" class="logo" border="0" height="68" /></a> 
  <div id="searchbar"> <img src="/eclipse.org-common/themes/Blue/images/searchbar_transition.gif" class="transition" alt="" height="26" width="92" /> 
    <img src="/eclipse.org-common/themes/Blue/images/searchbar_header.gif" class="header" alt="Search" height="17" width="64" /> 
    <form method="get" action="/search/search.cgi">
      ...
      <input class="button" src="/eclipse.org-common/themes/Blue/images/searchbar_submit.gif" alt="Submit" onclick="this.submit();" type="image" />
    </form>
  </div>
  <ul id="headernav">
