...
<?php
		...
		if( $Link->getURL() == "" ) {
			if($Link->getTarget() == "__SEPARATOR") {
				?>
<?= substr("                  ", 0, $level * 2) ?><li class="separator"><a class="separator"><?= $Link->getText() ?></a><?php
			} else {
				?>
<?= substr("                  ", 0, $level * 2) ?><li><a class="nolink" href="#"><?= $Link->getText() ?></a><?php
			...
			if($Link->getTarget() == "__SEPARATOR") {
				?>
<?= substr("                  ", 0, $level * 2) ?><li class="separator"><a class="separator" href="<?= $Link->getURL() ?>"><?= $Link->getText() ?></a><?php
			} else {
				?>
<?= substr("                  ", 0, $level * 2) ?><li><a href="<?= $Link->getURL() ?>"><?= $Link->getText() ?></a><?php
  ...
  <li style="background-image: url(/eclipse.org-common/themes/Industrial/images/leftnav_fade.jpg); background-repeat: repeat-x; border-style: none;">
			<br /><br /><br /><br /><br />
  </li>
</ul>
<? /*
