...
function NewsParse( $name, &$html, $id ) {
  ...
  for ( $loop = 1; $loop < $group_count; $loop+=2) {
	...
	$html .= "<p><a href=\"javascript:switchMenu('$news_name.$id');\" title=\"Description\"><img src='images/plus.gif' alt='Description' title=\"Description\"></a>  $news_html $webnews_html </p><div id=\"$news_name.$id\" class=\"switchcontent\"> <p>$description </p> <p>$newsarch_html</p> <p>$newssearch</p><br/></div><br/>";
  }          
}
